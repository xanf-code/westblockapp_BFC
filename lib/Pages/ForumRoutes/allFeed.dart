...
class AllFeedForumpage extends StatefulWidget {
  final String title;
  final User gCurrentUser;

  const AllFeedForumpage({Key key, this.title, this.gCurrentUser});
  @override
  _AllFeedForumpageState createState() => _AllFeedForumpageState();
}

class _AllFeedForumpageState extends State<AllFeedForumpage> {
