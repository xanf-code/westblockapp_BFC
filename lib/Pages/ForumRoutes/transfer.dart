...
class TransferForumpage extends StatefulWidget {
  final String title;
  final User gCurrentUser;

  const TransferForumpage({Key key, this.title, this.gCurrentUser});
  @override
  _TransferForumpageState createState() => _TransferForumpageState();
}

class _TransferForumpageState extends State<TransferForumpage> {
            ...
            Column(
              children: [
                ...
                Visibility(
                  visible: false,
                  child: TextFormField(
                    controller: typeEditingController..text = "transfer",
                  ),
                ),
                Padding(
        ...
        child: Column(
          children: [
            ...
            Visibility(
              visible: false,
              child: TextFormField(
                controller: onlyTypeEditingController..text = "transfer",
              ),
            ),
            Divider(
              height: 10,
