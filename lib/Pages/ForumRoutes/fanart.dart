...
class FanartForumpage extends StatefulWidget {
  final String title;
  final User gCurrentUser;

  const FanartForumpage({Key key, this.title, this.gCurrentUser});
  @override
  _FanartForumpageState createState() => _FanartForumpageState();
}

class _FanartForumpageState extends State<FanartForumpage> {
            ...
            Column(
              children: [
                ...
                Visibility(
                  visible: false,
                  child: TextFormField(
                    controller: typeEditingController..text = "fan",
                  ),
                ),
                Padding(
        ...
        child: Column(
          children: [
            ...
            Visibility(
              visible: false,
              child: TextFormField(
                controller: onlyTypeEditingController..text = "fan",
              ),
            ),
            Divider(
              height: 10,
