...
class ISLForumpage extends StatefulWidget {
  final String title;
  final User gCurrentUser;

  const ISLForumpage({Key key, this.title, this.gCurrentUser});
  @override
  _ISLForumpageState createState() => _ISLForumpageState();
}

class _ISLForumpageState extends State<ISLForumpage> {
  ...
  getAllPosts() async {
    ...
    QuerySnapshot querySnapshot =
        await AllPostsReference.where("type", isEqualTo: "isl")
            ...
            Column(
              children: [
                ...
                Visibility(
                  visible: false,
                  child: TextFormField(
                    controller: typeEditingController..text = "isl",
                  ),
                ),
                Padding(
        ...
        child: Column(
          children: [
            ...
            Visibility(
              visible: false,
              child: TextFormField(
                controller: onlyTypeEditingController..text = "isl",
              ),
            ),
            Divider(
              height: 10,
