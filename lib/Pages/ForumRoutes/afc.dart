...
class AFCForumpage extends StatefulWidget {
  final String title;
  final User gCurrentUser;

  const AFCForumpage({Key key, this.title, this.gCurrentUser});

  @override
  _AFCForumpageState createState() => _AFCForumpageState();
}

class _AFCForumpageState extends State<AFCForumpage> {
            ...
            Column(
              children: [
                ...
                Visibility(
                  visible: false,
                  child: TextFormField(
                    controller: typeEditingController..text = "afc",
                  ),
                ),
                Padding(
        ...
        child: Column(
          children: [
            ...
            Visibility(
              visible: false,
              child: TextFormField(
                controller: onlyTypeEditingController..text = "afc",
              ),
            ),
            Divider(
              height: 10,
