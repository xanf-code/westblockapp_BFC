...
class PreseasonForumpage extends StatefulWidget {
  final String title;
  final User gCurrentUser;

  const PreseasonForumpage({Key key, this.title, this.gCurrentUser});
  @override
  _PreseasonForumpageState createState() => _PreseasonForumpageState();
}

class _PreseasonForumpageState extends State<PreseasonForumpage> {
  ...
  getAllPosts() async {
    ...
    QuerySnapshot querySnapshot =
        await AllPostsReference.where("type", isEqualTo: "preseason")
            ...
            Column(
              children: [
                ...
                Visibility(
                  visible: false,
                  child: TextFormField(
                    controller: typeEditingController..text = "preseason",
                  ),
                ),
                Padding(
        ...
        child: Column(
          children: [
            ...
            Visibility(
              visible: false,
              child: TextFormField(
                controller: onlyTypeEditingController..text = "preseason",
              ),
            ),
            Divider(
              height: 10,
