...
class OFTForumpage extends StatefulWidget {
  final String title;
  final User gCurrentUser;

  const OFTForumpage({Key key, this.title, this.gCurrentUser});
  @override
  _OFTForumpageState createState() => _OFTForumpageState();
}

class _OFTForumpageState extends State<OFTForumpage> {
  ...
  getAllPosts() async {
    ...
    QuerySnapshot querySnapshot =
        await AllPostsReference.where("type", isEqualTo: "offtopic")
            ...
            Column(
              children: [
                ...
                Visibility(
                  visible: false,
                  child: TextFormField(
                    controller: typeEditingController..text = "offtopic",
                  ),
                ),
                Padding(
        ...
        child: Column(
          children: [
            ...
            Visibility(
              visible: false,
              child: TextFormField(
                controller: onlyTypeEditingController..text = "offtopic",
              ),
            ),
            Divider(
              height: 10,
